...
class KucluckProMusik extends Client {
    ...
    this.Manager = new Manager({
      ...
      .on("trackStart", async (player, track) => {
        ...
        let TrackStartedEmbed = new MessageEmbed()
          .setAuthor(`Memainkan Lagu ♪`, this.botconfig.IconURL)
      ...
      .on("queueEnd", (player) => {
        let QueueEmbed = new MessageEmbed()
          .setAuthor("Playlist telah habis", this.botconfig.IconURL)
          .setColor(this.botconfig.EmbedColor)
          .setTimestamp();
  ...
  sendError(Channel, Error) {
    let embed = new MessageEmbed()
      .setTitle("**ERROR** Terjadi kesalahan")
      .setColor("RED")
      .setDescription(Error)
      .setFooter(
        "Jika Anda menganggap ini sebagai bug, harap laporkan di server dukungan!"
      );
