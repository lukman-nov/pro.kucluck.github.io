    ...
    case "JOIN":
      if (stateChange.members.size === 1 && player.paused) {
        let emb = new MessageEmbed()
          .setAuthor(`Melanjutkan playlist yang dipause`, client.botconfig.IconURL)
          .setColor(client.botconfig.EmbedColor)
          .setDescription(
            `Melanjutkan pemutaran karena kalian semua meninggalkan aku dengan musik untuk dimainkan sendirian`
          );
