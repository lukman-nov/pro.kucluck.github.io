...
<body>
    ...
    <section id="welcome">
      <div class="heading">
        ...
        <br>
        <p>Welcome to Kucluck!</p>
        <p>These terms and conditions outline the rules and regulations for the use of Kucluck's Website, located at <a href="https://www.privacypolicyonline.com/terms-conditions-generator/" style="color: #c5c5c5;"> https://kucluck.com.</a></p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Kucluck if
        ...
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
          ...
          interchangeable and therefore as referring to same. Our Terms and Conditions were created with the help of the
          <a href="https://www.privacypolicyonline.com/terms-conditions-generator/" style="color: #c5c5c5;"> Terms &
            Conditions Generator</a>.</p>
        <br>
        <h3><strong>Cookies</strong></h3>
        <p>We employ the use of cookies. By accessing Kucluck, you agreed to use cookies in agreement with the Kucluck's
          Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, Kucluck and/or its licensors own the intellectual property rights for all material
          on Kucluck. All intellectual property rights are reserved. You may access this from Kucluck for your own
          personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <li>Republish material from Kucluck</li>
        <li>Sell, rent or sub-license material from Kucluck</li>
        <li>Reproduce, duplicate or copy material from Kucluck</li>
        <li>Redistribute content from Kucluck</li>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Kucluck does not filter, edit, publish or review Comments prior to their presence on the
          website. Comments do not reflect the views and opinions of Kucluck,its agents and/or affiliates. Comments
          reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
          applicable laws, Kucluck shall not be liable for the Comments or for any liability, damages or expenses caused
          and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
        </p>
        <p>Kucluck reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant Kucluck a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          Kucluck; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you must inform us by sending an e-mail to Kucluck. Please include your name, your organization name, contact
        ...
        <p>No use of Kucluck's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
        <br>
